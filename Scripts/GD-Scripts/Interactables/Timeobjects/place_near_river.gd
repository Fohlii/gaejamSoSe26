...
func _ready() -> void:
	...
	var withSapling: TimeobjectState = TimeobjectState.new("saplingPlantedInSpot", Vector2(3235.0,-357.0), 0, true, "res://Assets/Timeobjects/Textures/sapling.png", CircleShape2D.new(), "NONE")
