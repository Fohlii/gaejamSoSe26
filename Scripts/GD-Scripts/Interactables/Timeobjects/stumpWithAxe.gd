...
func _ready() -> void:
	var withAxe: TimeobjectState = TimeobjectState.new("stumpWithAxe", Vector2(2047.0,-324.0), 0, 1.0, true, "stump_with_axe.png")
	var withoutAxe: TimeobjectState = TimeobjectState.new("stumpWithoutAxe", Vector2(2047.0,-324.0), 0, 1.0, true, "stump.png", Vector2.ZERO, [], "axe.tres")
