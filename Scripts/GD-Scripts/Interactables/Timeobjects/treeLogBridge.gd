...
func _ready() -> void:
	...
	var treeLogInPlace: TimeobjectState = TimeobjectState.new("treeLogInPlace", Vector2(3519.0,-332.0), PI, true, "tree_log_bridge.png", Vector2.ZERO, [Vector2(-201,21),Vector2(198,27),Vector2(198,-8),Vector2(-200,-18)])
